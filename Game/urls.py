...
urlpatterns = [
    ...
    path('adminPanel/players/<str:pk>/status', views.statusPlayer, name='statusPlayer'),
    ...
    path('adminPanel/<str:pk>/editCountry', views.editCountry, name='editCountry'),
    path('adminPanel/<str:pk>/deleteCountry', views.deleteCountry, name='deleteCountry'),

    path('adminPanel/quiz', views.viewQuiz, name='viewQuiz'),
    path('adminPanel/quiz/<str:pk>/status', views.statusQuiz, name='statusQuiz'),
    ...
    path('playerPanel/<str:pk>/selectGuess', views.selectGuess, name='selectGuess'),
    path('playerPanel/<str:pk>/playCountry', views.playCountry, name='playCountry'),
    path('playerPanel/<str:pk>/playCity', views.playCity, name='playCity'),
    path('playerPanel/myMarks', views.myMarks, name='myMarks'),
    path('playerPanel/<str:pk>/markDetail', views.markDetail, name='markDetail'),
